...
namespace osu.Game.Rulesets.Karaoke.Input
{
    ...
    {
        //KaraokeGamePlay
        [Description("First BaseLyric")]
        FirstLyric, // 1 ,number_1
        ...
        [Description("Increase BaseLyric Appear Time")]
        IncreaseLyricAppearTime, //E

        [Description("Decrease BaseLyric Appear Time")]
        DecreaseLyricAppearTime, //D

        [Description("Reset BaseLyric Appear Time")]
